const HeroSection = () => (
    <section id="home" className="min-h-screen flex flex-col items-center justify-center text-center -mt-16">
        ...
        <p className="mt-4 text-lg md:text-2xl text-[var(--primary-color)] text-glow">Software Engineer & Systems Architect</p>
        <p className="mt-2 max-w-2xl text-base md:text-lg">Designing reliable, scalable, and secure solutions — where logic meets creativity. I build systems that connect, perform, and endure.</p>
